<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					<li>
						<img src="/res/site/img/h4-slidea.png" alt="Slide">
						<div class="caption-group">
							<h2 color= "white" class="caption title">
								Joias<strong> que combinam com você</strong></span>
							</h2>
							<h4 class="caption subtitle">Dual SIM</h4>
							<a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
						</div>
					</li>
					<li><img src="/res/site/img/h4-slide2b.png" alt="Slide">
						<div class="caption-group">
					...
					<li><img src="/res/site/img/h4-slide3c.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="/res/site/img/h4-slide4d.png" alt="Slide">
						<div class="caption-group">
						  <h2 class="caption title">
								Apple <span class="primary">Store <strong>Ipod</strong></span>
							</h2>
